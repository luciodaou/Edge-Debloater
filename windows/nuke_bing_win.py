...
def nuke_bing_from_edge():
    ...
    db_path = os.path.join(local_app_data, r"Microsoft\Edge\User Data\Default\Web Data")
    ...
    try:
        ...
        print("[-] PERMISSION DENIED: Microsoft Edge is currently running.")
        print("[-] Please close Edge completely (check Task Manager for 'msedge.exe') and try again.")
        return
    ...
    try:
        ...
        if "locked" in str(e).lower():
            ...
            print("[-] Open Task Manager, end all 'msedge.exe' processes, and rerun this script.")
        else:
